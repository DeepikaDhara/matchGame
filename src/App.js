      ...
      <div className="main-container">
        ...
        <div className="content-div">
            ...
            <div className="first-div">
              ...
              <ul className="thumbnail-images">
                {thumbnailList.map(eachObj=>(
                  <li key={eachObj.id}>
                  <button type="button" className="image-button" onClick={()=>this.imageClick(eachObj.thumbnailUrl)}>
                     <img src={eachObj.thumbnailUrl} className="thumbnail-image" alt="thumbnail"/>
                  </button>
                  </li>
                ))}
              </ul>
           ...
           {isTrue &&(
            ...
            <img src="https://assets.ccbp.in/frontend/react-js/match-game-trophy.png" alt="trophy" className="trophy-image"/>
            <p className="main-heading">YOUR SCORE</p>
            <p className="your-score">{score}</p>
            <button type="button" className="play-button" onClick={this.playAgain}>
              <img src="https://assets.ccbp.in/frontend/react-js/match-game-play-again-img.png " className="restart" alt="reset"/>
             PLAY AGAIN
            </button>
            </div>
           )}
